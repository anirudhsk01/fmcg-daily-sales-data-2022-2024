# FMCG Daily Sales Data Analysis (2022–2024)

## Introduction
This project involves the analysis of FMCG (Fast Moving Consumer Goods) daily sales data recorded between 2022 and 2024. The goal is to understand variations in product demand, sales behavior, pricing influence, and the role of stock availability and promotions in driving sales performance. The study supports decision-making in sales planning, inventory control, marketing strategy, and demand forecasting within FMCG and e-commerce environments.
...
## Steps Followed
1. Loaded and inspected the dataset to understand size, structure, and column definitions.
...
## Conclusion
The analysis reveals that FMCG sales performance is influenced by multiple operational factors including pricing, promotions, stock availability, and delivery speed. By focusing on top-selling products, optimizing stock levels, planning promotional events strategically, and improving logistics efficiency, organizations can increase revenue and enhance customer satisfaction.  
The insights from this project support **better demand forecasting, supply chain optimization, targeted marketing, and strategic business planning** in FMCG and e-commerce sectors.

---

## Acknowledgements
Dataset Source: Kaggle  
Project Domain: Sales & E-Commerce  
Performed By: **ANIRUDH S K**
